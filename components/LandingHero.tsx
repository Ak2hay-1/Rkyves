...
export default function LandingHero() {
  return (
    <section className="hero-glow relative min-h-screen overflow-hidden pt-28 md:pt-32">
      ...
      <div className="relative mx-auto mt-16 max-w-5xl px-4 sm:px-6 md:mt-20">
        <div className="overflow-hidden rounded-t-2xl border border-white/10 bg-[#0a0a0a] shadow-2xl shadow-purple-500/10">
